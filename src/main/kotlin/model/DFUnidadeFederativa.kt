...
enum class DFUnidadeFederativa(val codigo: String,
                               val descricao: String,
                               val codigoIbge: String,
                               val qrCodeHomologacao: String? = null,
                               val qrCodeProducao: String? = null,
                               val consultaChaveAcessoHomologacao: String? = null,
                               val consultaChaveAcessoProducao: String? = null) {
  AC("AC",
     "Acre",
     "12",
     "http://hml.sefaznet.ac.gov.br/nfce/qrcode",
     "http://hml.sefaznet.ac.gov.br/nfce/qrcode",
     "http://hml.sefaznet.ac.gov.br/nfce/consulta",
  ...
  AL("AL",
     ...
     "http://nfce.sefaz.al.gov.br/QRCode/consultarNFCe.jsp",
     "http://nfce.sefaz.al.gov.br/consultaNFCe.htm",
     "http://nfce.sefaz.al.gov.br/consultaNFCe.htm"),
  AP("AP",
     "Amap\u00E1",
     "16",
     "https://www.sefaz.ap.gov.br/nfcehml/nfce.php",
     "https://www.sefaz.ap.gov.br/nfce/nfce.php",
     "https://www.sefaz.ap.gov.br/sate1/seg/SEGf_AcessarFuncao.jsp?cdFuncao=FIS_1261",
     "https://www.sefaz.ap.gov.br/sate/seg/SEGf_AcessarFuncao.jsp?cdFuncao=FIS_1261"),
  AM("AM",
     "Amazonas",
     "13",
     "http://homnfce.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp",
     "http://sistemas.sefaz.am.gov.br/nfceweb/consultarNFCe.jsp",
     "homnfce.sefaz.am.gov.br/nfceweb/formConsulta.do",
     "sistemas.sefaz.am.gov.br/nfceweb/formConsulta.do"),
  BA("BA",
     "Bahia",
     "29",
  ...
  CE("CE",
     ...
     "https://nfeh.sefaz.ce.gov.br/pages/consultaChaveAcesso.jsf",
     "https://nfe.sefaz.ce.gov.br/pages/consultaChaveAcesso.jsf"),
  DF("DF",
     "Distrito Federal",
     "53",
     "http://dec.fazenda.df.gov.br/ConsultarNFCe.aspx",
     "http://dec.fazenda.df.gov.br/ConsultarNFCe.aspx",
     "http://dec.fazenda.df.gov.br/NFCE/",
     "http://dec.fazenda.df.gov.br/NFCE/"),
  GO("GO",
     "Goi\u00E1s",
     "52",
  ...
  MA("MA",
     ...
     "http://www.hom.nfce.sefaz.ma.gov.br/portal/consultarNFCe.jsp",
     "http://www.sefaz.ma.gov.br/nfce/consulta/"),
  MT("MT",
     "Mato Grosso",
     "51",
  ...
  RR("RR",
     ...
     "http://200.174.88.103:8080/nfce/servlet/wp_consulta_nfce",
     "https://www.sefaz.rr.gov.br/nfce/servlet/wp_consulta_nfce"),
  SP("SP",
     "S\u00E3o Paulo",
     "35",
  ...
  SE("SE",
     ...
     "http://www.hom.nfe.se.gov.br/portal/portalNoticias.jsp",
  ...
  NACIONAL("NC", "Nacional", "90"), RFB("RFB", "RFB", "91"), EX("EX", "Exterior", "99");
  ...
  companion object {
    fun valueOfCodigo(codigo: String?): DFUnidadeFederativa {
      for (uf in values()) {
        if (uf.codigo.equals(StringUtils.trim(codigo), ignoreCase = true)) {
          return uf
        }
        else if (uf.codigoIbge.equals(StringUtils.trim(codigo), ignoreCase = true)) {
          return uf
        }
      }
      throw IllegalArgumentException(String.format("N\u00e3o existe o c\u00f3digo %s no mapeamento.", codigo))
    }
  }
}